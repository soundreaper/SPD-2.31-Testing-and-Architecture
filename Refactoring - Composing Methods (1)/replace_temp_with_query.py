...
class School:
    ...
    def process_graduation(self):
        ...
        passed_students = self._process_students()

        # process the top 10% of passed students
        self._process_top_10(passed_students)

    def _process_students(self):
        ...
        # print the graduation banner
        self._print_graduation_banner(passed_students)
    ...
    def _print_graduation_banner(self, passed_students):
    ...
    def _process_top_10(self, passed_students):
